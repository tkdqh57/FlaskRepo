...
board_blp = Blueprint('Boards', 'boards', description="Operations on bords", url_prefix = '/board')
...
class BoardResource(MethodView):
    ...
    def put(self, board_id):
        ...
        return jsonify({'mag':'Successfully updated board data'}), 201
    ...
    def delete(self, board_id):
        ...
        return jsonify({'mag':'Successfully updated board data'}), 204